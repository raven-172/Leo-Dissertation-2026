...
The dataset should be organized as described in the [YOLOv5 documentation](./train-custom-data.md). The dataset config `yaml` file must follow the same format as that of the `coco128.yaml` file.
