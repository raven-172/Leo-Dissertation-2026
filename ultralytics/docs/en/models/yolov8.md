...
![YOLOv8 performance comparison charts](https://cdn.ul.run/i/7dd03f050503e5700d4cf85d6ea7ae3f.avif)
...
The YOLOv8 series offers a diverse range of models, each specialized for specific tasks in computer vision. These models are designed to cater to various requirements, from object detection to more complex tasks like [instance segmentation](https://www.ultralytics.com/glossary/instance-segmentation), classification, pose/keypoints detection, and oriented object detection.
...
!!! tip "Performance"
    ...
    === "Detection (COCO)"
        ...
        | ------------------------------------------------------------------------------------ | --------------------- | -------------------- | ------------------------------ | ----------------------------------- | ------------------ | ----------------- |
        | [YOLOv8n](https://platform.ultralytics.com/ultralytics/yolov8/yolov8n) | 640                   | 37.3                 | 80.4                           | 0.99                                | 3.2                | 8.7               |
        | [YOLOv8s](https://platform.ultralytics.com/ultralytics/yolov8/yolov8s) | 640                   | 44.9                 | 128.4                          | 1.20                                | 11.2               | 28.6              |
        | [YOLOv8m](https://platform.ultralytics.com/ultralytics/yolov8/yolov8m) | 640                   | 50.2                 | 234.7                          | 1.83                                | 25.9               | 78.9              |
        | [YOLOv8l](https://platform.ultralytics.com/ultralytics/yolov8/yolov8l) | 640                   | 52.9                 | 375.2                          | 2.39                                | 43.7               | 165.2             |
        | [YOLOv8x](https://platform.ultralytics.com/ultralytics/yolov8/yolov8x) | 640                   | 53.9                 | 479.1                          | 3.53                                | 68.2               | 257.8             |
    ...
    === "Segmentation (COCO)"
        ...
        | -------------------------------------------------------------------------------------------- | --------------------- | -------------------- | --------------------- | ------------------------------ | ----------------------------------- | ------------------ | ----------------- |
        | [YOLOv8n-seg](https://platform.ultralytics.com/ultralytics/yolov8/yolov8n-seg) | 640                   | 36.7                 | 30.5                  | 96.1                           | 1.21                                | 3.4                | 12.6              |
        | [YOLOv8s-seg](https://platform.ultralytics.com/ultralytics/yolov8/yolov8s-seg) | 640                   | 44.6                 | 36.8                  | 155.7                          | 1.47                                | 11.8               | 42.6              |
        | [YOLOv8m-seg](https://platform.ultralytics.com/ultralytics/yolov8/yolov8m-seg) | 640                   | 49.9                 | 40.8                  | 317.0                          | 2.18                                | 27.3               | 110.2             |
        | [YOLOv8l-seg](https://platform.ultralytics.com/ultralytics/yolov8/yolov8l-seg) | 640                   | 52.3                 | 42.6                  | 572.4                          | 2.79                                | 46.0               | 220.5             |
        | [YOLOv8x-seg](https://platform.ultralytics.com/ultralytics/yolov8/yolov8x-seg) | 640                   | 53.4                 | 43.4                  | 712.1                          | 4.02                                | 71.8               | 344.1             |
    ...
    === "Classification (ImageNet)"
        ...
        | -------------------------------------------------------------------------------------------- | --------------------- | ---------------- | ---------------- | ------------------------------ | ----------------------------------- | ------------------ | ------------------------ |
        | [YOLOv8n-cls](https://platform.ultralytics.com/ultralytics/yolov8/yolov8n-cls) | 224                   | 69.0             | 88.3             | 12.9                           | 0.31                                | 2.7                | 0.5                      |
        | [YOLOv8s-cls](https://platform.ultralytics.com/ultralytics/yolov8/yolov8s-cls) | 224                   | 73.8             | 91.7             | 23.4                           | 0.35                                | 6.4                | 1.7                      |
        | [YOLOv8m-cls](https://platform.ultralytics.com/ultralytics/yolov8/yolov8m-cls) | 224                   | 76.8             | 93.5             | 85.4                           | 0.62                                | 17.0               | 5.3                      |
        | [YOLOv8l-cls](https://platform.ultralytics.com/ultralytics/yolov8/yolov8l-cls) | 224                   | 76.8             | 93.5             | 163.0                          | 0.87                                | 37.5               | 12.3                     |
        | [YOLOv8x-cls](https://platform.ultralytics.com/ultralytics/yolov8/yolov8x-cls) | 224                   | 79.0             | 94.6             | 232.0                          | 1.01                                | 57.4               | 19.0                     |
    ...
    === "Pose (COCO)"
        ...
        | ---------------------------------------------------------------------------------------------------- | --------------------- | --------------------- | ------------------ | ------------------------------ | ----------------------------------- | ------------------ | ----------------- |
        | [YOLOv8n-pose](https://platform.ultralytics.com/ultralytics/yolov8/yolov8n-pose)       | 640                   | 50.4                  | 80.1               | 131.8                          | 1.18                                | 3.3                | 9.2               |
        | [YOLOv8s-pose](https://platform.ultralytics.com/ultralytics/yolov8/yolov8s-pose)       | 640                   | 60.0                  | 86.2               | 233.2                          | 1.42                                | 11.6               | 30.2              |
    ...
    === "OBB (DOTAv1)"
        ...
        |----------------------------------------------------------------------------------------------|-----------------------| -------------------- | -------------------------------- | ------------------------------------- | -------------------- | ----------------- |
        | [YOLOv8n-obb](https://platform.ultralytics.com/ultralytics/yolov8/yolov8n-obb) | 1024                  | 78.0                 | 204.77                           | 3.57                                  | 3.1                  | 23.3              |
        | [YOLOv8s-obb](https://platform.ultralytics.com/ultralytics/yolov8/yolov8s-obb) | 1024                  | 79.5                 | 424.88                           | 4.07                                  | 11.4                 | 76.3              |
        | [YOLOv8m-obb](https://platform.ultralytics.com/ultralytics/yolov8/yolov8m-obb) | 1024                  | 80.5                 | 763.48                           | 7.61                                  | 26.4                 | 208.6             |
        | [YOLOv8l-obb](https://platform.ultralytics.com/ultralytics/yolov8/yolov8l-obb) | 1024                  | 80.7                 | 1278.42                          | 11.83                                 | 44.5                 | 433.8             |
        | [YOLOv8x-obb](https://platform.ultralytics.com/ultralytics/yolov8/yolov8x-obb) | 1024                  | 81.36                | 1759.10                          | 13.23                                 | 69.5                 | 676.7             |
...
Note the below example is for YOLOv8 [Detect](../tasks/detect.md) models for object detection. For additional supported tasks see the [Segment](../tasks/segment.md), [Classify](../tasks/classify.md), [Pose](../tasks/pose.md), and [OBB](../tasks/obb.md) docs.
