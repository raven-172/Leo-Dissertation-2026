...
!!! tip "Performance"
    ...
    === "Detection (COCO)"
        ...
        | ------------------------------------------------------------------------------------ | ---------------------       | --------------------       | ------------------------------       | -----------------------------------       | ------------------       | -----------------       |
        | [YOLO11n](https://platform.ultralytics.com/ultralytics/yolo11/yolo11n) | 640                         | 39.5                       | 56.1 ± 0.8                           | 1.5 ± 0.0                                 | 2.6                      | 6.5                     |
        | [YOLO11s](https://platform.ultralytics.com/ultralytics/yolo11/yolo11s) | 640                         | 47.0                       | 90.0 ± 1.2                           | 2.5 ± 0.0                                 | 9.4                      | 21.5                    |
        | [YOLO11m](https://platform.ultralytics.com/ultralytics/yolo11/yolo11m) | 640                         | 51.5                       | 183.2 ± 2.0                          | 4.7 ± 0.1                                 | 20.1                     | 68.0                    |
        | [YOLO11l](https://platform.ultralytics.com/ultralytics/yolo11/yolo11l) | 640                         | 53.4                       | 238.6 ± 1.4                          | 6.2 ± 0.1                                 | 25.3                     | 86.9                    |
        | [YOLO11x](https://platform.ultralytics.com/ultralytics/yolo11/yolo11x) | 640                         | 54.7                       | 462.8 ± 6.7                          | 11.3 ± 0.2                                | 56.9                     | 194.9                   |
    ...
    === "Segmentation (COCO)"
        ...
        | -------------------------------------------------------------------------------------------- | ---------------------       | --------------------       | ---------------------       | ------------------------------       | -----------------------------------       | ------------------       | -----------------       |
        | [YOLO11n-seg](https://platform.ultralytics.com/ultralytics/yolo11/yolo11n-seg) | 640                         | 38.9                       | 32.0                        | 65.9 ± 1.1                           | 1.8 ± 0.0                                 | 2.9                      | 9.7                     |
        | [YOLO11s-seg](https://platform.ultralytics.com/ultralytics/yolo11/yolo11s-seg) | 640                         | 46.6                       | 37.8                        | 117.6 ± 4.9                          | 2.9 ± 0.0                                 | 10.1                     | 33.0                    |
        | [YOLO11m-seg](https://platform.ultralytics.com/ultralytics/yolo11/yolo11m-seg) | 640                         | 51.5                       | 41.5                        | 281.6 ± 1.2                          | 6.3 ± 0.1                                 | 22.4                     | 113.2                   |
        | [YOLO11l-seg](https://platform.ultralytics.com/ultralytics/yolo11/yolo11l-seg) | 640                         | 53.4                       | 42.9                        | 344.2 ± 3.2                          | 7.8 ± 0.2                                 | 27.6                     | 132.2                   |
        | [YOLO11x-seg](https://platform.ultralytics.com/ultralytics/yolo11/yolo11x-seg) | 640                         | 54.7                       | 43.8                        | 664.5 ± 3.2                          | 15.8 ± 0.7                                | 62.1                     | 296.4                   |
    ...
    === "Classification (ImageNet)"
        ...
        | -------------------------------------------------------------------------------------------- | ---------------------       | ----------------       | ----------------       | ------------------------------       | -----------------------------------       | ------------------       | ------------------------       |
        | [YOLO11n-cls](https://platform.ultralytics.com/ultralytics/yolo11/yolo11n-cls) | 224                         | 70.0                   | 89.4                   | 5.0 ± 0.3                            | 1.1 ± 0.0                                 | 2.8                      | 0.5                            |
        | [YOLO11s-cls](https://platform.ultralytics.com/ultralytics/yolo11/yolo11s-cls) | 224                         | 75.4                   | 92.7                   | 7.9 ± 0.2                            | 1.3 ± 0.0                                 | 6.7                      | 1.6                            |
        | [YOLO11m-cls](https://platform.ultralytics.com/ultralytics/yolo11/yolo11m-cls) | 224                         | 77.3                   | 93.9                   | 17.2 ± 0.4                           | 2.0 ± 0.0                                 | 11.6                     | 4.9                            |
        | [YOLO11l-cls](https://platform.ultralytics.com/ultralytics/yolo11/yolo11l-cls) | 224                         | 78.3                   | 94.3                   | 23.2 ± 0.3                           | 2.8 ± 0.0                                 | 14.1                     | 6.2                            |
        | [YOLO11x-cls](https://platform.ultralytics.com/ultralytics/yolo11/yolo11x-cls) | 224                         | 79.5                   | 94.9                   | 41.4 ± 0.9                           | 3.8 ± 0.0                                 | 29.6                     | 13.6                           |
    ...
    === "Pose (COCO)"
        ...
        | ---------------------------------------------------------------------------------------------- | ---------------------       | ---------------------       | ------------------       | ------------------------------       | -----------------------------------       | ------------------       | -----------------       |
        | [YOLO11n-pose](https://platform.ultralytics.com/ultralytics/yolo11/yolo11n-pose) | 640                         | 50.0                        | 81.0                     | 52.4 ± 0.5                           | 1.7 ± 0.0                                 | 2.9                      | 7.4                     |
        | [YOLO11s-pose](https://platform.ultralytics.com/ultralytics/yolo11/yolo11s-pose) | 640                         | 58.9                        | 86.3                     | 90.5 ± 0.6                           | 2.6 ± 0.0                                 | 9.9                      | 23.1                    |
        | [YOLO11m-pose](https://platform.ultralytics.com/ultralytics/yolo11/yolo11m-pose) | 640                         | 64.9                        | 89.4                     | 187.3 ± 0.8                          | 4.9 ± 0.1                                 | 20.9                     | 71.4                    |
        | [YOLO11l-pose](https://platform.ultralytics.com/ultralytics/yolo11/yolo11l-pose) | 640                         | 66.1                        | 89.9                     | 247.7 ± 1.1                          | 6.4 ± 0.1                                 | 26.1                     | 90.3                    |
        | [YOLO11x-pose](https://platform.ultralytics.com/ultralytics/yolo11/yolo11x-pose) | 640                         | 69.5                        | 91.1                     | 488.0 ± 13.9                         | 12.1 ± 0.2                                | 58.8                     | 202.8                   |
    ...
    === "OBB (DOTAv1)"
        ...
        | -------------------------------------------------------------------------------------------- | ---------------------       | ------------------       | ------------------------------       | -----------------------------------       | ------------------       | -----------------       |
        | [YOLO11n-obb](https://platform.ultralytics.com/ultralytics/yolo11/yolo11n-obb) | 1024                        | 78.4                     | 117.6 ± 0.8                          | 4.4 ± 0.0                                 | 2.7                      | 16.8                    |
        | [YOLO11s-obb](https://platform.ultralytics.com/ultralytics/yolo11/yolo11s-obb) | 1024                        | 79.5                     | 219.4 ± 4.0                          | 5.1 ± 0.0                                 | 9.7                      | 57.1                    |
        | [YOLO11m-obb](https://platform.ultralytics.com/ultralytics/yolo11/yolo11m-obb) | 1024                        | 80.9                     | 562.8 ± 2.9                          | 10.1 ± 0.4                                | 20.9                     | 182.8                   |
        | [YOLO11l-obb](https://platform.ultralytics.com/ultralytics/yolo11/yolo11l-obb) | 1024                        | 81.0                     | 712.5 ± 5.0                          | 13.5 ± 0.6                                | 26.1                     | 231.2                   |
        | [YOLO11x-obb](https://platform.ultralytics.com/ultralytics/yolo11/yolo11x-obb) | 1024                        | 81.3                     | 1408.6 ± 7.7                         | 28.6 ± 1.0                                | 58.8                     | 519.1                   |
...
Note that the example below is for YOLO11 [Detect](../tasks/detect.md) models for [object detection](https://www.ultralytics.com/glossary/object-detection). For additional supported tasks, see the [Segment](../tasks/segment.md), [Classify](../tasks/classify.md), [Pose](../tasks/pose.md), and [OBB](../tasks/obb.md) docs.
...
!!! tip "Ultralytics YOLO11 Publication"
    ...
    Ultralytics has not published a formal research paper for YOLO11 due to the rapidly evolving nature of the models. We focus on advancing the technology and making it easier to use, rather than producing static documentation. For the most up-to-date information on YOLO architecture, features, and usage, please refer to our [GitHub repository](https://github.com/ultralytics/ultralytics) and [documentation](../index.md).
