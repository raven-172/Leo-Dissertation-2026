...
<p>
    <img width="1709" alt="Ultralytics Explorer GUI main dashboard interface" src="https://cdn.ul.run/i/21d5ef59dc96909047855598246a1e42.avif">
</p>
...
<p>
<img width="1710" alt="Explorer selecting airplane images for similarity search" src="https://cdn.ul.run/i/438d61266b90712817daf81b0f735ce0.avif">
</p>

After running the similarity search, you should see similar results:

<p>
<img width="1710" alt="Ultralytics Explorer semantic similarity search" src="https://cdn.ul.run/i/5e6da49affd14d00c20a40b3c2dd9fb5.avif">
</p>
...
<p>
<img width="1709" alt="Explorer Ask AI results for images with 5 persons" src="https://cdn.ul.run/i/4a82f06d0a19f579e82abf02def6eea1.avif">
</p>
...
<p>
<img width="1707" alt="Explorer SQL query filtering images with person and dog" src="https://cdn.ul.run/i/9cccbd83e7362925751029e79265a3de.avif">
</p>
