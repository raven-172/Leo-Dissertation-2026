...
The YOLO26 depth family (`yolo26n-depth.pt`, `yolo26s-depth.pt`, `yolo26m-depth.pt`, `yolo26l-depth.pt`, `yolo26x-depth.pt`) auto-downloads from Ultralytics releases and is trained on the broad multi-dataset mix that Hypersim is part of. Explore [YOLO26x-depth](https://platform.ultralytics.com/ultralytics/yolo26/yolo26x-depth) on Ultralytics Platform.
